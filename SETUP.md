...
3. **แชทชั่วคราว** - กดปุ่ม "แชทชั่วคราว" (ไม่บันทึกลง DB)
4. **ประวัติแชท** - ดูรายการแชททั้งหมดใน sidebar
5. **เปลี่ยนชื่อ** - กดจุด 3 จุดที่แชท เลือก "เปลี่ยนชื่อ"
6. **ลบแชท** - กดจุด 3 จุดที่แชท เลือก "ลบแชท"
...
สร้างโดย .NET 10 + Next.js 16 + Gemini AI ✨
